...
ManasPDF is built to render PDF files quickly and efficiently. This application provides a simple interface for viewing PDF documents. It's designed to take full advantage of GPU capabilities to enhance performance.

## 🚀 Getting Started

To use ManasPDF, follow these steps:
...
4. Follow the prompts in the installation wizard. This generally includes accepting license terms and choosing a destination folder. 

5. After the installation is complete, you can find ManasPDF in your Start menu. Click on it to open the application.
...
- Ensure you have administrative rights on your computer to install new software.
- If you encounter security prompts, click "Allow" or "Run" to proceed.

## 🔍 Features

- **Fast Rendering:** Utilizes GPU acceleration for smooth performance.
- **User-Friendly:** Simple and intuitive interface for ease of use.
- **Versatile Support:** Compatible with various PDF documents and formats.
- **Open Source:** Contribute to the development and improvement of ManasPDF.

## 🖥️ System Requirements

ManasPDF is optimized for modern Windows systems. Recommended requirements include:

- Operating System: Windows 10 or newer
- RAM: 4 GB minimum
- GPU: Any Direct2D compatible graphics card
- Disk Space: At least 200 MB of free space

## 📚 Usage Instructions

After installation, open ManasPDF. Use the following options:

- **Open PDF:** Click on the "Open" button to browse and select a PDF file.
- **View Controls:** Navigate through pages using arrows or the scrollbar.
- **Zoom Feature:** Adjust the zoom level for better readability.

## 📧 Feedback

We welcome your feedback and suggestions. Please report any bugs or issues using the GitHub Issues tab in this repository.
...
If you'd like to contribute to ManasPDF, visit our repository to learn how you can help improve the project. We appreciate contributions from developers and non-developers alike.
